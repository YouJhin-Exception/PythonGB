...
#@dp.message_handler(Text(equals = [emoji.emojize(':mobile_phone:calc')]), no.new_calc)
...
#@dp.message_handler(Text(equals = [emoji.emojize(':video_game:play')]), noc.c_play)
#@dp.callback_query_handler(Text(equals="yes"), noc.callbackInline)
